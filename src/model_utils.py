...
def criar_pipeline_svm(
    ...
    # escala só as colunas contínuas, passa as binárias sem alteração
    preprocessor = ColumnTransformer(transformers=[
        ('scaler', RobustScaler(), colunas_continuas),
    ], remainder='passthrough')   # ← colunas binárias passam sem transformação
